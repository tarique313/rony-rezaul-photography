...
/*!
 *	is_int
 *	fonction qui teste si une valeur est un entier ou non
 *	
 *	@argument :	value {int}
 *	@returns :	bool
 *	@requires :	none
...
/*!
 *	isElementById
 *	fonction qui teste si un element definit par don id existe dans la page
 *	
 *	@argument :	e {string}
 *	@returns :	bool
 *	@requires :	none
...
function verifieChar(evenement,type){
	...
	if(charCode==8||charCode==46||charCode==9||charCode==13){
		// backspace ou del ou tab ou enter
		return true;
	}else{
		switch(type){
			case 0:
 ...
 *	@requires :	none
 */
function printPhoneNumber(idSpan){
	...
	if(is_int(majTelephone)){
		...
		console.log('echec dans la fonction printPhoneNumber - '+majTelephone);
	}
}
/*!
 *	printemail
